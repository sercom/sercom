        ...
        <table style="width:100%">
            <tr>
                <td class="contexto" py:if="not tg.identity.anonymous">
                  ...
                  <span py:for="i in [x for x in SessionHelper().get_contexto_usuario().get_curso().instancias_a_corregir if x.activo and datetime.now()>=x.inicio]" py:if="'docente' in tg.identity.groups">
