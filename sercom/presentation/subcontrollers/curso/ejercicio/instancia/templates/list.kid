...
<table class="list">
    ...
    <tr py:for="record in records">
        ...
        <td align="center"><span py:replace="tg.strbool(record.fin is not None)">procesada</span></td>
        <td align="center"><span py:replace="tg.strbool(record.inicio is not None and record.fin is None)">en proceso</span></td>
